...
import com.example.tiffinhubs.databinding.BuyAgainItemBinding
        ...
        override fun onBindViewHolder(holder: BuyAgainViewHolder, position: Int) {
            ...
            holder.itemView.setOnClickListener{
               ...
               // intent.putExtra("MenuItemImage",buyAgainFoodImage[position])
                intent.putExtra("MenuItemPrice",buyAgainFoodPrice[position])

                //intent.putExtra("MenuItemDescription",bu)
